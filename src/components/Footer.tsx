...
export default function FooterSection() {
  return (
    <footer className="bg-gradient-to-br from-slate-900 via-gray-900 to-zinc-900 text-white relative overflow-hidden px-6 py-12">
      ...
      {/* Main Content */}
      <div className="relative z-10 max-w-7xl mx-auto flex flex-row lg:flex-row justify-between items-start gap-12">
        {/* Brand Section (Left) */}
      ...
      {/* Bottom Bar */}
      <div className="relative z-10 border-t border-gray-700/50 mt-12 pt-6 mx-5 text-sm text-gray-400 flex flex-col lg:flex-row justify-between items-center gap-4">
